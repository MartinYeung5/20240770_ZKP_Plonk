...
假設參數:
* 第2列是指第1個門，左輸入X6是3、右輸入X5是33及OUT輸出是99。
* 第3列是指第2個門，左輸入X1是1、右輸入X2是2及X6是3。
* 第4列是指第3個門，左輸入X3是3、右輸入X4是11及X5是33。
* 第5列是沒有指向任何門，只是其中一個輸出約束，左輸入是0、右輸入是0及輸出是99。